  ...
  return (
    <form onSubmit={handleSubmit(handleShippingForm)} className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
            ...
            <input className="border-b border-gray-200 py-2 outline-none text-sm" type="text" id="name" placeholder="Eg. Rohit Mathur" {...register("name")} value={"johny bae"} />
...
{/* email  */}
        ...
        <div className="flex flex-col gap-1">
            ...
            <input className="border-b border-gray-200 py-2 outline-none text-sm" type="email" id="email" placeholder="Eg. example@eg.com" {...register("email")} value={"dashsdb@gmail.com"} />
...
{/* Phone  */}
        ...
        <div className="flex flex-col gap-1">
            ...
            <input className="border-b border-gray-200 py-2 outline-none text-sm" type="phone" id="phone" placeholder="Eg. 1234567" {...register("phone")} value={"949384773"}/>
...
{/* address  */}
        ...
        <div className="flex flex-col gap-1">
            ...
            <input className="border-b border-gray-200 py-2 outline-none text-sm" type="text" id="address" placeholder="Eg. 1234 Address" {...register("address")} value={"dhc fddj fda"} />
...
{/* city  */}
        ...
        <div className="flex flex-col gap-1">
            ...
            <input className="border-b border-gray-200 py-2 outline-none text-sm" type="city" id="city" placeholder="Eg. Denmark" {...register("city")} value={"nreafdjkv"}/>
